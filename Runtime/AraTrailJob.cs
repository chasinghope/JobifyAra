...
namespace AraJob
{
    ...
    public class AraTrailJob : MonoBehaviour
    {
        ...
        [HideInInspector] public Camera tempCamera;
            ...
            NativeArray<int> tris, int index_tris, int len_tris)
        {
            ...
            {
                Debug.LogError("SetIndices");
                throw;
            }

            RenderMesh(tempCamera);
            //Debug.Log($"len_vertices: {len_vertices} len_vertColors: {len_vertColors}  len_uvs: {len_uvs}  len_tris: {len_tris}");
